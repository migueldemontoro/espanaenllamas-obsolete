	...
	<div id="container">
		...
		<?php zilla_header_start(); ?>
			<div class="inner clearfix">
				...
				<!-- BEGIN #primary-nav -->
	    		<div id="primary-nav">
	    			<?php wp_nav_menu( array( 'theme_location' => 'primary-menu', 'container' => 'div', 'after' => '<span class="sep">/</span>', 'fallback_cb' => false ) ); ?>
	    		<!-- END #primary-nav -->
	    		</div>
	    		<?php zilla_nav_after(); ?>
						...
						<div class="feature <?php echo strtolower($background); ?>">
							...
							<div class="feature-content">
								...
								<div class="feature-content-meta">
									<span class="author"><?php _e('By', 'zilla') ?> <?php the_author_posts_link(); ?></span>
