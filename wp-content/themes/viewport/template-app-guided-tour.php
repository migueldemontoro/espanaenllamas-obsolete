              ...
              <div class="capitulo">                    
                ...
                <div id="textos-historias">
                  <div id="t1" class="txtf">
                    ...
                    <p>La comunidad autónoma más afectada fue Galicia, donde se quemaron un 24% del total de las hectáreas arrasadas por el fuego en España. El 80% de esos incendios fueron provocados. En segundo lugar se sitúa Castilla y León, que suma un 19% de la superficie total calcinada durante esos 13 años.</p>
                    <p>Los datos facilitados por el Gobierno en relación a las pérdidas económicas y los gastos en extinción de incendios forestales son muy incompletos. De acuerdo a esas informaciones oficiales, los siniestros costaron al erario público más de 2.400 millones de euros.</p>
                  </div>
                  ...
                  <div id="t3" class="txtf">
                    <p>Las condiciones meteorológicas resultan un factor clave para que los fuegos se propaguen rápidamente o no. El 68 por ciento de la superficie quemada durante el periodo 2001-2013 ardió en los meses de verano. Agosto es el mes en el que más incendios ocurrieron.</p>
                    <p>Sin embargo, el día que más destaca es el 27 de julio. En esa fecha se produjeron 998 incendios, un número que esconde el 3,55% del total de hectáreas calcinadas.</p>
                  ...
                  <div id="t5" class="txtf">
                    ...
                    <p>Sin embargo, el año más aciago del siglo XXI para los bosques en cuanto a hectáreas quemadas fue 2012. El fuego quemó 216.893 hectáreas de superficie forestal</b>, o 2.168 km². Para poner en valor esa cifra, apuntamos que la provincia de Guipúzcoa tiene 1.980 km².</p>
                  </div>
                  <div id="t6" class="txtf">
                    ...
                    <p>2006 fue fatídico para Galicia y sus bosques. Sólo en julio y agosto se iniciaron más de 4.000 fuegos. Para finales de diciembre, las llamas habían arrasado 95.947 hectáreas de superficie forestal, casi un tercio del total de las quemadas en Galicia entre 2001 y 2013. Exactamente un 26,18%.</p>
                  ...
                  <div id="t8" class="txtf">
                    <p>El 3,74% del suelo calcinado entre 2005 (primer dato disponible) y 2013 estaba en un espacio natural protegido. El hecho de estar "protegido" no los pone a salvo de las llamas.</p>
                    <p>Un caso llamativo es el Parque Natural del Lago de Sanabria (Zamora), el mayor lago de origen glaciar de la Península. En tan sólo seis años sufrió 186 incendios que abrasaron 667 hectáreas, según los datos facilitados por el Ministerio de Agricultura, Alimentación y Medio Ambiente. Casi todos esos fuegos figuran en los partes oficiales de incendios como intencionados.</p>
