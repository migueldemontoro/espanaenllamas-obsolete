<?php
/*
Template Name: España en Llamas - Vis1
*/
?>
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
          ...
          <?php zilla_page_start(); ?>
            ...
            <div class="entry-content">
              ...
              <aside>Click en cualquier celda para hacer zoom; click en la parte más alta para subir un nivel.</aside>
              -->
            <!--END .entry-content -->
            </div>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/vis/vis1/js/app.js"></script>
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/vis/vis1/styles/app.css"/>